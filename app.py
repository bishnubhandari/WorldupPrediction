...
def init_db():
    ...
    default_users = [
        ...
        ("knshresth", hash_password("Predict!2026"), "KN shresth"),
        ("ksvgautam", hash_password("Predict!2026"), "ksv Gautam"),
        ("ashishkhadka", hash_password("Predict!2026"), "Ashish Khadka"),
        ("amrit", hash_password("Predict!2026"), "Amrit"),
        ("kumar", hash_password("Predict!2026"), "Kumar"),
        ("rzes", hash_password("Predict!2026"), "Rzes"),
        ("yukesh", hash_password("Predict!2026"), "Yukesh"),
        ("puskar", hash_password("Predict!2026"), "Puskar"),
        ("nissan", hash_password("Predict!2026"), "Nissan"),
        ("abhishek", hash_password("Predict!2026"), "Abhishek"),
        ("pawan", hash_password("Predict!2026"), "Pawan"),
        ("kamal", hash_password("Predict!2026"), "Kamal"),
        ("lushan", hash_password("Predict!2026"), "Lushan"),
        ("ani", hash_password("Predict!2026"), "Ani"),
        ("subaaz", hash_password("Predict!2026"), "Subaaz"),
        ("drona", hash_password("Predict!2026"), "Drona"),
        ("mahesh", hash_password("Predict!2026"), "Mahesh"),
        ("hemant", hash_password("Predict!2026"), "Hemant"),
        ("nischal", hash_password("Predict!2026"), "Nischal"),
        ("umesh", hash_password("Predict!2026"), "Umesh"),
        ("dinesh", hash_password("Predict!2026"), "Dinesh"),
        ("ashishkhatri", hash_password("Predict!2026"), "Ashish Khatri"),
        ("janak", hash_password("Predict!2026"), "Janak"),
        ("bishnu", hash_password("Predict!2026"), "Bishnu"),
        ("madan", hash_password("Predict!2026"), "Madan"),
        ("prakash", hash_password("Predict!2026"), "Prakash"),
        ("raaz", hash_password("Predict!2026"), "Raaz")
    ]
