...
def init_db():
    ...
    default_users = [
        ...
        ("knshrestha", hash_password("KnS#7202"), "knshrestha"),
        ("ksvgautam", hash_password("KsvG!4091"), "ksvgautam"),
        ("ashishkhadka", hash_password("Ashish#8301"), "ashishkhadka"),
        ("amrit", hash_password("Amrit$2026"), "Amrit"),
        ("kumar", hash_password("Kumar!8892"), "Kumar"),
        ("rzes", hash_password("Rzes#3901"), "Rzes"),
        ("yukesh", hash_password("Yukesh$9902"), "Yukesh"),
        ("puskar", hash_password("Puskar!7201"), "puskar"),
        ("nissan", hash_password("Nissan#4819"), "Nissan"),
        ("abhishek", hash_password("Abhi$3910"), "Abhishek"),
        ("pawan", hash_password("Pawan!2903"), "Pawan"),
        ("kamal", hash_password("Kamal#8291"), "Kamal"),
        ("lushan", hash_password("Lushan$3820"), "Lushan"),
        ("anil", hash_password("Anil!9012"), "Anil"),
        ("subaaz", hash_password("Subaaz#4891"), "subaaz"),
        ("drona", hash_password("Drona$3819"), "drona"),
        ("mahesh", hash_password("Mahesh!8201"), "mahesh"),
        ("hemant", hash_password("Hemant#4829"), "hemant"),
        ("nischal", hash_password("Nischal$8391"), "nischal"),
        ("umesh", hash_password("Umesh!3810"), "umesh"),
        ("dinesh", hash_password("Dinesh#9201"), "dinesh"),
        ("janak", hash_password("Janak$3829"), "janak"),
        ("bishnu", hash_password("Bishnu!7291"), "bishnu"),
        ("madan", hash_password("Madan#8392"), "madan"),
        ("prakash", hash_password("Prakash$3821"), "prakash"),
        ("raaz", hash_password("Raaz!8391"), "raaz"),
        ("lotus", hash_password("Lotus#2839"), "lotus")
    ]
